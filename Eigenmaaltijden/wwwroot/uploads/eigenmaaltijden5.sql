...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 29 mrt 2021 om 12:39
...
INSERT INTO `maaltijd_info` (`MealID`, `AmountAvailable`, `Type`, `PortionPrice`, `PortionWeight`, `Fresh`, `PreparedOn`, `Availability`) VALUES
(3, 5, 1, 2.5, 200, 1, '2021-03-22', 0),
(4, 3, 1, 4, 350, 1, '2021-03-22', 0),
(5, 3, 1, 1.5, 100, 1, '2021-03-25', 0);
...
(1, 'klaas@gmail.com', 'Test1234', 35483460),
(2, 'pieter@gmail.com', 'ILoveKlaas', 0),
(3, 'anna@gmail.com', 'AIOHSDina', 0),
(4, 'lissa@gmail.com', '^alkmnsdCAS&', 0),
(5, 'kees@gmail.com', 'Test1234', 0),
(11, 'klaas2@gmail.com', 'Test1234', 0),
(12, 'heleen@gmail.com', 'Test', 388332070),
(14, 'Test@test.nl', 'TestTest', 412966475);
...
(14, 'TestStraat', 1, NULL, 'TestPlaat', 'Duitsland', '1234ZA');
...
CREATE TABLE `verkoper_profiel` (
  ...
  `Description` text NOT NULL,
  `EmailHidden` tinyint(3) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `verkoper_profiel` (`UserID`, `Name`, `ProfilePhotoPath`, `Description`, `EmailHidden`) VALUES
(1, 'Klaas Jackson', 'img/pf/asduihconzxc.png', 'Goed in de keuken', 0),
(2, 'Pieter Andreson', 'img/pf/vhuioasnjc.png', 'Goed in de keuken', 0),
(3, 'Anna Andreson', 'img/pf/onsidhgsuhdb.png', 'Goed in de keuken', 0),
(4, 'Lissa Vegas', 'img/pf/noasd8ibnsod.png', 'Goed in de keuken', 0),
(11, 'Klaas Pieterson', 'img/users/default.png', '', 0),
(12, 'Heleen Homan', 'img/users/default.png', '', 0),
(14, 'Test', 'img/users/default.png', '', 0);
